...
cities = [{'name':'Wrocław', 'county':'Wrocław', 'state':'Lower Silesian Voivodeship', 'lat':51.126308, 'lng':16.978201},
          ...
          {'name':'Olecko', 'county':'gmina Olecko', 'state':'Warmian-Masurian Voivodeship', 'lat':54.03606, 'lng':22.501789},
          {'name':'Oleśnica', 'county':'Oleśnica', 'state':'Lower Silesian Voivodeship', 'lat':51.210239, 'lng':17.38295},
          {'name':'Stegna', 'county':'Stegna', 'state':'Pomeranian Voivodeship', 'lat':54.29821, 'lng':19.040609},
          {'name':'Wielka Lipa', 'county':'Oborniki Śląskie', 'state':'Lower Silesian Voivodeship', 'lat':51.317039, 'lng':16.85873},
          {'name':'Grzybki', 'county':'Warta', 'state':'Łódź Voivodeship', 'lat':51.72723, 'lng':18.604321},
          {'name':'Rypin', 'county':'Rypin', 'state':'Kuyavian-Pomeranian Voivodeship', 'lat':53.062962, 'lng':19.419331},
          {'name':'Borucino', 'county':'Połczyn-Zdrój', 'state':'West Pomeranian Voivodeship', 'lat':53.75692, 'lng':16.030861},
          ...
          {'name':'Janczyce', 'county':'gmina Baćkowice', 'state':'Świętokrzyskie Voivodeship', 'lat':50.762051, 'lng':21.2372},
          {'name':'Częstochowa', 'county':'Częstochowa', 'state':'Silesian Voivodeship', 'lat':50.808998, 'lng':19.124411}]
