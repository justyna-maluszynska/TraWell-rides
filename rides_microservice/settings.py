"""
Django settings for rides_microservice project.
...
SECRET_KEY = 'django-insecure-8tyxb-*zghoa%f90mt4y3h1$yk#u3(gobt#qn%@6e87-h=0ee-'
...
WSGI_APPLICATION = 'rides_microservice.wsgi.application'
